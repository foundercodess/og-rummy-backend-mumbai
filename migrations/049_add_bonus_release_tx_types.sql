-- Add bonus release transaction types used when pending bonus gets converted to cash.
...
COMMENT ON CONSTRAINT chk_wallet_transactions_type ON wallet_transactions
  IS 'Allowed wallet ledger types including game settlement, entry debits, and pending bonus release conversions';
