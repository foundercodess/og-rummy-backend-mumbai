-- Re-apply full client contest data (in case 013 was already run with partial data).
-- Points: 14 tiers. 201/101 Pool: 19 entry fees. Deals: 2 players only, 19 entries. Spin & Go: 3 players only, 8 tiers.
...
BEGIN
  ...
  -- POINT RUMMY: 14 tiers (2 and 6 players each)
  ...
  -- 201 POOL: 19 entry fees (2 and 6 players each)
  ...
  -- 101 POOL: same as 201 (19 entry fees, 2 and 6 players)
  ...
  -- DEALS: 2 players only, 19 entry fees (5–100000)
  ...
  -- SPIN & GO: 3 players only, 8 tiers (play_type 3 only)
